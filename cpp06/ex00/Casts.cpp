...
Casts::Casts() : inputString(""), typeInputString(""), _char(0), _int(0), _float(0.0F), _double(0.0) {
}

Casts::Casts(std::string inputString) : inputString(inputString), typeInputString(""), _char(0), _int(0),
...
void Casts::getType() {
    if (this->inputString.compare("-inf") == 0 || this->inputString.compare ("+inf") == 0
            || this->inputString.compare("nan") == 0) {
        this->typeInputString = "optional";
    } else if (this->inputString.compare("-inff") == 0 || this->inputString.compare("+inff") == 0
            || this->inputString.compare("nanf") == 0){
        this->typeInputString = "optional";
        ...
        if (isNumber && (sign == 1 || sign == 0)) {
            if (isdigit(this->inputString[i]) != 0 && countDot == 1) {
                ...
                this->typeInputString = "int";
                return;
            } else if (this->inputString[this->inputString.size() - 1] == 'f' && (countDot == 2 || countDot == 1)) {
...
void Casts::adapter() {
    ...
    if (this->typeInputString.compare("float") == 0 || this->typeInputString.compare("double") == 0) {
